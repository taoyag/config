...
"                 Preview, sort commands and advanced search for Quickfix.
"         Author: Futoshi Ueno <fuenor@gmail.com>
"                 http://sites.google.com/site/fudist/Home  (Japanese)
"  Last Modified: 2009-12-23 22:53
"        Version: 2.02
"=============================================================================
"
"What Is This:
"  This plugin adds preview, sort commands and advanced search to your quickfix window.
"
"Install:
...
"
"Usage:
"  Execute command(vimgrep,grep,make,etc.), then open the quickfix window.
"
"Commands:
"  Quickfix window:
"  |  q  | Close.
...
"  |  S  | Sort commands.
"  |  s  | Advanced search.
"  |  r  | Advanced search(exclude)
"  |  u  | Undo.
"  |  U  | Undo all.
"
"  Normal mode:
"  | <C-w>, | Open/Close a quickfix window.
"  | <C-w>. | Move focus to a quickfix window or open.
"             To set height of a quickfix window to specified number: >
"             3<C-w>.
"
"  Command mode:
"  :OpenQFixWin
...
"  :MoveToQFixWin
"
"  You can also use copen/cclose.
"
"Options:
"
"  let g:QFix_Height = 10
"    Default height for a quickfix window.
"
"  let g:QFix_Width  = 0
"    Default width for a quickfix window.
"
"  let g:QFix_CopenCmd = ''
"    Normally the quickfix window is at the bottom of the screen.  If there are
"    vertical splits, it's at the bottom of the rightmost column of windows.
"    To make it always occupy the full width: >
"      let g:QFix_CopenCmd = 'botright'
"    To make it always occupy the full height: >
"      let g:QFix_CopenCmd = 'vertical topleft'
"
"=============================================================================
...
function! QFixEditFile(file)
  ...
  let opt = ''
  exec "edit " . opt . escape(expand(file), ' ')
endfunction
